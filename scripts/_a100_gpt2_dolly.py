...
RUN_ROOT = f"/root/bdshield_runs/gpt2_dolly_{time.strftime('%Y%m%d_%H%M%S')}"
SHARDS = 4
...
if __name__ == "__main__":
    ...
    experiments = [
        ("gpt2_dolly",
         str(CONFIGS / "gpt2_selfinstruct_backdoor.yaml"),
         str(CONFIGS / "gpt2_selfinstruct_clean.yaml"),
         str(CONFIGS / "gpt2_selfinstruct_detection.yaml")),
    ]
